      ...
      <div className="glass-panel border-glass-border rounded-lg shadow-2xl max-w-2xl w-full mx-4 p-8 animate-in zoom-in-95 duration-200">
        ...
        <div className="mb-8">
          ...
          <p className="text-text-muted mb-6">
            Marky works directly with the files on your machine. Choose the folder that contains (or
            will contain) all of your markdown notes. You can reorganize files in the sidebar, and
            the changes will immediately reflect on disk.
          </p>
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="text-text-primary font-semibold mb-1">
                {isLoading ? "Opening…" : "Choose Notes Folder"}
              </h3>
              <p className="text-text-muted text-sm">
                Select the root directory for your workspace. Existing markdown files will appear
                instantly.
              </p>
            </div>
          </button>
        ...
        <div className="bg-bg-editor border border-border rounded-lg p-4 mb-6">
          ...
          <ul className="text-text-muted text-sm space-y-2 list-disc list-inside">
            <li>
              Every file action (create, rename, move, delete) is mirrored directly on your drive.
            </li>

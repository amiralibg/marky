        ...
        <div className="flex items-start gap-4 mb-5">
          ...
          <div>
            ...
            <p className="text-text-muted text-sm">
              You need a workspace folder before you can create notes. Marky saves notes directly to
              your file system.
            </p>
          </div>
        </div>
          ...
          >
            ...
            <div>
              <p className="text-text-primary text-sm font-medium">
                {isLoading ? "Opening…" : "Import Existing Folder"}
              </p>
              <p className="text-text-muted text-xs">
                Pick a folder that already contains your markdown files.
              </p>
            </div>
          </button>
        </div>

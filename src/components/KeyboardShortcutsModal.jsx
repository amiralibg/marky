  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div 
          className="bg-sidebar-bg border border-white/10 rounded-xl shadow-2xl w-full max-w-2xl max-h-[85vh] flex flex-col pointer-events-auto animate-slideUp"
        ...
        >
                        ...
                        <div className="flex items-center gap-1">
                          {shortcut.keys.map((key, keyIndex) => (
                            <span key={keyIndex} className="inline-flex items-center">
                              <kbd className="px-2 py-1 text-xs font-mono bg-white/10 border border-white/20 rounded shadow-sm text-white">
                                {key}
                              </kbd>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-secondary">
                    Press <kbd className="px-1.5 py-0.5 text-xs font-mono bg-white/10 border border-white/20 rounded">Cmd/Ctrl</kbd> + <kbd className="px-1.5 py-0.5 text-xs font-mono bg-white/10 border border-white/20 rounded">?</kbd> anytime to view this help panel.
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* Footer */}
          <div className="border-t border-white/10 px-6 py-4 flex justify-end shrink-0">
            <button
              onClick={onClose}
              className="px-4 py-2 text-sm font-medium bg-accent text-white hover:bg-accent/90 rounded-lg transition-colors"
            >
              Got it!
            </button>
          </div>

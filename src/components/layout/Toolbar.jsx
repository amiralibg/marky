...
const ICONS = {
  ...
  strikethrough: (
    ...
    >
      ...
      <path d="M12 12h4c1.5 0 3 1 3 3a3 3 0 0 1-3 3H8" />
  ...
  h1: (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
      <text x="2" y="17" fontSize="14" fontWeight="700" fontFamily="system-ui">
        H
      </text>
      <text x="14" y="19" fontSize="10" fontWeight="600" fontFamily="system-ui">
        1
      </text>
    </svg>
  ),
  ...
  numberedList: (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
      <text x="2" y="8" fontSize="7" fontWeight="600" fontFamily="system-ui">
        1.
      </text>
      <text x="2" y="14.5" fontSize="7" fontWeight="600" fontFamily="system-ui">
        2.
      </text>
      <text x="2" y="21" fontSize="7" fontWeight="600" fontFamily="system-ui">
        3.
      </text>
      <rect x="11" y="5" width="10" height="1.5" rx="0.5" />
      <rect x="11" y="11.5" width="10" height="1.5" rx="0.5" />
      <rect x="11" y="18" width="10" height="1.5" rx="0.5" />
    </svg>
  ),
  taskList: (
    <svg
  ...
  footnote: (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
      <text x="3" y="16" fontSize="13" fontWeight="600" fontFamily="system-ui">
        T
      </text>
      <text x="14" y="10" fontSize="9" fontWeight="700" fontFamily="system-ui">
        1
      </text>
    </svg>
  ),
...
const TAB_BUTTONS = {
  ...
  insert: [
    ...
    },
    {
      ...
      after: "]",
      placeholder: "1",
      tooltip: "Footnote — add [^1]: text at bottom",
    },
    {
      id: "mathInline",
      label: "Math",
